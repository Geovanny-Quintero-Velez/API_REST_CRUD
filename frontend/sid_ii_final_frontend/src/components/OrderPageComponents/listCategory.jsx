...
const ListCategory = ({ categories, selectedCategory, onSelectedCategory, filterProducts}) => (
  <div className='flex flex-row'>
    ...
    <select value={selectedCategory} onChange={(e) => onSelectedCategory(e.target.value)} className='w-4/5 mb-5 ml-3 rounded-md border-alter border-2 hover:border-2 hover:border-alter'>
